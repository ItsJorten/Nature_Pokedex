    ...
    >
      ...
      <View style={styles.statsContainer}>
        <View style={styles.statCard}>
          <View style={[styles.statIconContainer, { backgroundColor: colors.category.plant + '20' }]}>
            <Ionicons name="leaf" size={24} color={colors.category.plant} />
          </View>
      ...
      <View style={styles.scanButtonContainer}>
        ...
        >
          <View style={styles.scanButtonInner}>
            <Ionicons name="camera" size={40} color={colors.text.inverse} />
        ...
        {observationsCount === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyDescription}>
              Start exploring! Take a photo of something in nature to add it to your collection.
            </Text>
            <Button
      ...
      <View style={styles.section}>
        ...
        <View style={styles.quickActions}>
          <TouchableOpacity style={styles.quickAction} onPress={goToCollection}>
          ...
          <TouchableOpacity style={styles.quickAction} onPress={goToCollection}>
            <View style={[styles.quickActionIcon, { backgroundColor: colors.category.animal + '15' }]}>
              <Ionicons name="filter-outline" size={24} color={colors.category.animal} />
            </View>
...
const styles = StyleSheet.create({
  ...
  statLabel: { fontSize: typography.size.sm, color: colors.text.secondary, marginTop: spacing.xs },
  scanButtonContainer: { alignItems: 'center', marginBottom: spacing.xl },
  scanButton: {
    width: 140,
    height: 140,
    borderRadius: borderRadius.full,
  ...
  placeholderText: { fontSize: typography.size.md, color: colors.text.secondary },
